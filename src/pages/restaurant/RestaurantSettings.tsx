              ...
              <div className="bg-gradient-to-br from-gray-50 to-gray-50 rounded-lg md:rounded-xl p-4 md:p-6 border border-purple-100">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 mb-6">
                  <button
                    type="button"
                    onClick={() => {
                      updateFormData('settings.theme.primary_color', '#e6735c');
                      updateFormData('settings.theme.secondary_color', '#f4c095');
                      updateFormData('settings.theme.menu_background_color', '#fff8f3');
                      updateFormData('settings.theme.card_background_color', '#ffffff');
                      updateFormData('settings.theme.primary_text_color', '#3b2f2f');
                      updateFormData('settings.theme.secondary_text_color', '#6f6464');
                    }}
                  ...
                  >
                    <div className="flex flex-col gap-1 w-full">
                      <div className="h-6 rounded-t" style={{ backgroundColor: '#e45454' }}></div>
                      <div className="flex gap-1">
                        <div className="flex-1 h-8 rounded" style={{ backgroundColor: '#2c2c2c' }}></div>
                        <div className="flex-1 h-8 rounded" style={{ backgroundColor: '#fff4f4' }}></div>
                      </div>
                    </div>
                    <span className="text-xs font-medium text-gray-700">Coral Rose</span>
                  </button>
