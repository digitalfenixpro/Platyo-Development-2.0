...
const translations: Record<Language, Translations> = {
  es: {
    ...
    primary_color_hint: 'Botones principales',
    secundary_color_label: 'Color Secundario',
    secundary_color_hint: 'Botones secundarios',
  ...
  en: {
    ...
    secundary_color_label: 'Secundary Color',
    secundary_color_hint: 'Secundary Buttons',
